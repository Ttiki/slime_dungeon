...
public class TitleScene : Scene
{
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if (Core.Input.Keyboard.WasKeyJustPressed(Keys.Enter)) Core.ChangeScene(new GameScene());
    ...
    private void CreateTitlePanel()
    {
        ...
        startButton.Anchor(Anchor.BottomLeft);
        startButton.X = 50;
        startButton.Y = -12;
        ...
        _optionsButton.Anchor(Anchor.BottomRight);
        _optionsButton.X = -50;
        _optionsButton.Y = -12;

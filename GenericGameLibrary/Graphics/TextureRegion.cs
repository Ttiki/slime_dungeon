...
public class TextureRegion
{
    ...
    /// <param name="x">
    ///     The x-coordinate position of the upper-left corner of this texture region relative to the upper-left
    ///     corner of the source texture.
    /// </param>
    /// <param name="y">
    ///     The y-coordinate position of the upper-left corner of this texture region relative to the upper-left
    ///     corner of the source texture.
    /// </param>

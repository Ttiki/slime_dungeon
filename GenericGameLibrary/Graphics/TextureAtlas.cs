...
public class TextureAtlas
{
    ...
    /// <param name="x">
    ///     The top-left x-coordinate position of the region boundary relative to the top-left corner of the source
    ///     texture boundary.
    /// </param>
    /// <param name="y">
    ///     The top-left y-coordinate position of the region boundary relative to the top-left corner of the source
    ///     texture boundary.
    /// </param>
